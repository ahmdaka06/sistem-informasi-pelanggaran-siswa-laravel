...
<head>
    ...
    @livewireScripts
    <title>{{ get_config('title') }} - @yield('title')</title>
</head>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <span
                                class="d-none d-xl-inline-block ms-1 fw-medium font-size-15">{{ Auth::guard('admin')->user()->username }}</span>
                                    ...
                                    @if (count($page['breadcrumb']) > 1)
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a
                                                    href="{{ url('/') }}">{{ get_config('title') }}</a></li>
                                            <li class="breadcrumb-item"><a
                                                    href="#">{{ $page['breadcrumb']['first'] }}</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">
                                                {{ $page['breadcrumb']['second'] }}</li>
                                        </ol>
                                    @else
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a
