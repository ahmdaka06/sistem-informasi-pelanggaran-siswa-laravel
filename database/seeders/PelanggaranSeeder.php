...
class PelanggaranSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $daftar_pelanggaran_all = array_merge($daftar_pelanggaran, $daftar_pelanggaran_sedang, $daftar_pelanggaran_berat);
        ViolationLists::truncate();
        ViolationCategory::truncate();
        ViolationCategory::insert($daftar_pelanggaran_all);
    }
}
